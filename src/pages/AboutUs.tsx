...
const AboutUs=()=>{
    ...
    return(
        ...
        <h2>About Us</h2>
            ...
            <p>Explore our menu to discover a wide range of mouthwatering dishes and expertly crafted cocktails, all made with the finest ingredients and a whole lot of love.</p>
            <p>Thank you for choosing [Food and Cocktails]. We look forward to serving you!</p>
